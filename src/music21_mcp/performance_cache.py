...
class PerformanceCache:
    ...
    def _generate_chord_key(self, chord_obj: chord.Chord, key_obj: Optional[key.Key] = None) -> str:
        """
    ...
    def get_roman_numeral(self, chord_obj: chord.Chord, key_obj: key.Key) -> Optional[Tuple[str, int]]:
        """
    ...
    def get_chord_analysis(self, chord_obj: chord.Chord, key_obj: Optional[key.Key], 
                          include_inversions: bool) -> dict[str, Any]:
        """
    ...
    def get_cache_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "total_cache_entries": len(self._roman_numeral_cache) + len(self._chord_analysis_cache)
        }
