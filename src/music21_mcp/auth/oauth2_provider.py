...
from .models import (
    AuthorizationCode, AuthorizationRequest, AccessToken, RefreshToken,
    ClientRegistration, TokenRequest, TokenResponse, GrantType,
    User, OAuth2ServerMetadata, OAuth2ProtectedResourceMetadata
)
...
class OAuth2Provider:
    ...
    async def _handle_authorization_code_grant(
        ...
        if self.config.require_pkce or auth_code.code_challenge:
            ...
            if auth_code.code_challenge_method == "S256":
                ...
                computed_challenge = secrets.token_urlsafe(32)[:43]  # Simplified for example
    ...
    def get_server_metadata(self) -> OAuth2ServerMetadata:
        ...
        return OAuth2ServerMetadata(
            ...
            code_challenge_methods_supported=["S256", "plain"] if self.config.require_pkce else []
        )
