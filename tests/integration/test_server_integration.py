...
from music21_mcp.server import (ScoreManager, ServerConfig,
                                SimpleCircuitBreaker, SimpleRateLimiter,
                                cleanup_memory, create_resilient_tool,
                                health_check, initialize_tools)
...
class TestMemoryCleanup:
    ...
    async def test_cleanup_memory(self):
        ...
        with patch(
            "music21_mcp.server.score_manager._cleanup_old_scores"
        ) as mock_cleanup:
