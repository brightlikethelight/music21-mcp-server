...
from music21_mcp.server import (analyze_bach_chorale_style, analyze_fugue,
                                analyze_species_counterpoint,
                                analyze_voice_independence,
                                check_voice_leading, score_manager)
...
class TestCounterpointEndpoints:
    ...
    async def test_voice_leading_parallel_fifths(self, setup_parallel_fifths_score):
        ...
        result = await check_voice_leading(
            score_id=setup_parallel_fifths_score, check_parallels=True
        )
    ...
    async def test_fugue_analysis(self, setup_fugue_score):
        """Test fugue analysis"""
        result = await analyze_fugue(score_id=setup_fugue_score, subject_length=8)
...
class TestComplexCounterpointScenarios:
    ...
    async def test_fugue_with_stretto(self):
        ...
        result = await analyze_fugue(score_id="stretto_fugue", subject_length=8)
