...
from music21_mcp.server import (analyze_chord_progressions, analyze_key,
                                analyze_rhythm, analyze_scale, batch_analysis,
                                chromatic_analysis, comprehensive_analysis,
                                export_score, generate_report, identify_scale,
                                import_score, interval_vector,
                                phrase_structure, score_manager,
                                secondary_dominants)
...
class TestScoreManagement:
    ...
    async def test_import_score_from_file(self, temp_midi_file):
        ...
        result = await import_score(
            score_id="test_score", source=temp_midi_file, validate=True
        )
...
CDEF|GABc|"""
        ...
        result = await import_score(
            score_id="abc_test", source={"content": abc_content}, source_type="abc"
        )
    ...
    async def test_export_score_to_midi(self, simple_score):
        ...
        result = await export_score(score_id="export_test", format="midi")
    ...
    async def test_export_score_invalid_format(self, simple_score):
        ...
        result = await export_score(score_id="export_test2", format="invalid_format")
...
class TestTheoryAnalysis:
    ...
    async def test_analyze_key_endpoint(self, simple_score):
        ...
        result = await analyze_key(score_id="key_test", method="hybrid")
    ...
    async def test_analyze_scale_endpoint(self, simple_score):
        ...
        result = await analyze_scale(
            score_id="scale_test", include_modes=True, include_exotic=True
        )
    ...
    async def test_analyze_chord_progressions(self, chord_progression_score):
        ...
        result = await analyze_chord_progressions(
            score_id="chord_test", analysis_type="roman"
        )
...
class TestRhythmAnalysis:
    ...
    async def test_analyze_rhythm_endpoint(self, complex_rhythm_score):
        ...
        result = await analyze_rhythm(score_id="rhythm_test", include_patterns=True)
...
class TestAdvancedTheory:
    ...
    async def test_identify_scale(self, simple_score):
        ...
        result = await identify_scale(
            score_id="scale_id_test", confidence_threshold=0.7
        )
    ...
    async def test_interval_vector(self, chord_progression_score):
        ...
        result = await interval_vector(score_id="iv_test")
    ...
    async def test_chromatic_analysis(self):
        ...
        result = await chromatic_analysis(
            score_id="chromatic_test", include_voice_leading=True
        )
    ...
    async def test_secondary_dominants(self):
        ...
        result = await secondary_dominants(score_id="secondary_test")
    ...
    async def test_phrase_structure(self, simple_score):
        ...
        result = await phrase_structure(score_id="phrase_test", include_motives=False)
...
class TestIntegrationTools:
    ...
    async def test_comprehensive_analysis(self, simple_score):
        ...
        result = await comprehensive_analysis(
            score_id="comprehensive_test", include_advanced=True
        )
    ...
    async def test_batch_analysis(self, simple_score, chord_progression_score):
        ...
        result = await batch_analysis(
            score_ids=["batch1", "batch2"], analysis_types=["key", "rhythm"]
        )
    ...
    async def test_generate_report(self, simple_score):
        ...
        # Test summary report
        result = await generate_report(score_id="report_test", report_format="summary")
        ...
        result = await generate_report(
            score_id="report_test", report_format="educational"
        )
...
class TestErrorHandling:
    ...
    async def test_import_invalid_source(self):
        ...
        result = await import_score(score_id="invalid_test", source="not_a_file.xyz")
    ...
    async def test_batch_analysis_with_missing_scores(self):
        ...
        result = await batch_analysis(
            score_ids=["exists", "missing"], analysis_types=["key"]
        )
