...
from src.music21_mcp.core.rhythm_analyzer import (MeterAnalysis,
                                                  RhythmAnalyzer,
                                                  RhythmicComplexity,
                                                  TempoAnalysis)
...
class TestRhythmAnalyzer:
    ...
    async def test_pattern_extraction(self, analyzer):
        ...
        patterns = await analyzer._extract_rhythmic_patterns(
            s, min_length=4, min_occurrences=3
        )
    ...
    async def test_rhythmic_complexity(self, analyzer):
        ...
        assert complex_result.complexity in [
            ...
            RhythmicComplexity.VERY_COMPLEX,
        ]
