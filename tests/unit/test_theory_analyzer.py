...
from src.music21_mcp.core.theory_analyzer import (IntervalAnalysis,
                                                  KeyAnalysisResult,
                                                  KeyDetectionMethod,
                                                  TheoryAnalyzer)
...
class TestTheoryAnalyzer:
    ...
    async def test_key_detection_simple(self, analyzer, simple_score):
        ...
        result = await analyzer.analyze_key(
            simple_score, method=KeyDetectionMethod.KRUMHANSL
        )
    ...
    async def test_key_detection_hybrid(self, analyzer, simple_score):
        ...
        result = await analyzer.analyze_key(
            simple_score, method=KeyDetectionMethod.HYBRID
        )
    ...
    async def test_key_detection_with_modulation(self, analyzer):
        ...
        result = await analyzer.analyze_key(
            s, window_size=4  # Analyze in 4-measure windows
        )
