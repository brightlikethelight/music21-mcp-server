...
from music21 import converter, corpus, key, stream
...
async def import_score(score_id: str, source: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "score_id": score_id,
            "measures": (
                len(score.parts[0].getElementsByClass("Measure")) if score.parts else 0
            ),
        }
...
async def list_scores() -> Dict[str, Any]:
    ...
    return {"scores": list(scores.keys()), "count": len(scores)}
